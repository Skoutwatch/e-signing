...
use App\Nova\Metrics\Users\ActiveUsers;
...
class User extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Boolean::make('National Verification')->hideWhenCreating(),

            Boolean::make('System Verification')->hideWhenCreating(),
            ...
            Text::make('last activity')->hideFromIndex()->hideWhenCreating()->hideWhenUpdating(),

            Text::make('created at')->hideFromIndex()->hideWhenCreating()->hideWhenUpdating(),
