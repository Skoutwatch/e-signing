...
use App\Http\Resources\Team\TeamUsersDeletedResource;
...
class TeamResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'active' => $this->teamActiveForUser ? true : false,
            'subscription' => new SubscriptionResource($this->whenLoaded('subscription')),
            'users' => TeamUserShortDetailsResource::collection($this->whenLoaded('users')),
            'usersDeleted' => TeamUsersDeletedResource::collection($this->whenLoaded('deletedUsers')),
