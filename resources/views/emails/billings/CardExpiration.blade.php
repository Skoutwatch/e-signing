    ...
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="align-center" align="center" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; text-align: center;" width="100%">
        <tr>
            <td style="font-family: Poppins, sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                <img src="{{ config('externallinks.s3_storage_url') }}mail_icon/CARD+EXPIRATION.png" height="90" alt="ToNote" style="border: none; -ms-interpolation-mode: bicubic; max-width: 100%;">
            </td>
        </tr>
    </table>
</div>
      ...
      <table cellpadding="0" cellspacing="0" role="presentation">
        <tr>
            <td style="padding-bottom: 40px">
                <span>
                    Your ${{ $detail['cardType'] }} debit card with last four digits "${{ $detail['last4Digits'] }}" will be expiring next month ${{ $detail['expiryMonth'] }}/${{ $detail['expiryYear'] }}.
                </span>
                <br />
                <span>
                    You can change your card from the <a href="#settingspageUrl" style="text-decoration: underline; color: #0000ff;">settings</a> page on the ToNote platform to continue enjoying our services.
                </span>
            </td>
        </tr>
      </table>
