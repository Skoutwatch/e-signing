...
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    Status : {{ $document?->scheduleSession?->transaction?->status }}
</p>
...
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    ...
    <ol>
        ...
        <li>In the event that a session is not completed successfully
            <a href="{{ $policy_link }}" style="text-decoration: none; color: #fff; padding: 12px 32px; background: #003BB3; box-shadow: 0px 14px 14px rgba(0, 0, 0, 0.1); border-radius: 4px;">
            click here
            </a>
