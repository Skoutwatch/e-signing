...
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    We thought you'd appreciate the reminder. Your current plan expires on the {{ $detail['end_at'] }} and will be automatically renewed.
</p>
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    Renewal Date: <br> {{ $detail['end_at'] }}
</p>
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    Estimated Renewal Charge: ₦{{$detail['subscription_amount'] }}
</p>
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 25px;">
    You can change your plan, payment method and billing details on the <a href="#settings_page_url" style="text-decoration: underline; color: #0000ff;">settings</a> page on the platform.
</p>
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
