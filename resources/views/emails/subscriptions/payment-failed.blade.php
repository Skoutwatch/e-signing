...
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Hi <span> {{ $transaction->user->first_name }}</span>, </p>

<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    This message is to inform you that your payment of <b> ₦{{ $transaction->amount_paid }}  </b> failed.
</p>
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    Customer ID: <br> <span> {{ $transaction->user->id }} </span>
</p>
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    Payment ID: <br>
...
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    Date: <br> <span> {{ $transaction->created_at->format('M j, Y - g:ia') }} </span>
</p>
