...
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Hello {{ $detail->user->first_name }}, </p>
...
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    To ensure this document is notarized legally, you will need to join a virtual session, where you will be connected with a Supreme Court Certified notary, who will treat your request. The online session should last approximately 10minutes.
</p>
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    Please select a suitable session time from this <a href="https://calendly.com/tonote-/tonote-session-request">link.</a>
</p>
  <p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 25px;">
    Once you schedule your session, you will receive an email with a link to join.
  </p>

  <p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: bold; margin: 0; margin-bottom: 25px;">
    Kindly note that our Notaries operate within the hours of 9:00AM to 6:00PM, Monday to Friday.
  </p>
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    For support contact us <a href="mailto:ask@gettonote.com">Here</a>
  </p>
