...
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Hi {{ $parentDocument?->user?->first_name }}, </p>

<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    {{ $userFormData?->first_name }}  {{  $userFormData?->last_name }} has signed your document, <b> {{ $document->title }} </b>. Click the link below to view the signed document.
</p>
