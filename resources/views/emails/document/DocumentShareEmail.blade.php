...
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Hello {{ $document->user->first_name }}, </p>

<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    Your session has been successfully completed and your document is attached.
</p>

<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    Very soon, you will be able to schedule sessions and connect with the notary directly from
    your ToNote dashboard, so keep an eye out for that email update.
</p>

<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    We advise that you download this document and store it on your secure digital locker on
    ToNote. This way you have access to the document if you ever need it.
</p>
