...
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Hi {{ $document->user->first_name }}, </p>
...
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    {{ $document->approvers->first_name }} has approved the document, {{ $document->title }}.
</p>
@elseif ($userAction->status == "Signed")
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    {{ $document->approvers->first_name }} has signed the document, {{ $document->title }}.
</p>
@elseif ($userAction->status == "Declined")
<p style="font-family: Poppins, sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
    {{ $document->approvers->first_name }} has declined to approve the document, {{ $document->title }} due to {{ $message }}.
</p>
@endif
